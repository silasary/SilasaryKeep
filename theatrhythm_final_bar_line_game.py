...
from Options import OptionSet, TextChoice
...
class TheatrhythmFinalBarLineArchipelagoOptions:
    ...
    theatrhythm_final_bar_line_max_difficulty: TheatrhythmFinalBarLineMaxDifficulty
...
class TheatrhythmFinalBarLineGame(Game):
    ...
    def difficulties(self) -> List[str]:
        return [
            ...
            "EXPERT",
            "ULTIMATE / SUPREME",
        ][:self.archipelago_options.theatrhythm_final_bar_line_max_difficulty.value + 1]
...
class TheatrhythmFinalBarLineMaxDifficulty(TextChoice):
    """
    Indicates the maximum difficulty of songs that can be played.
    """
